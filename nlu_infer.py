...
def nlu_predict(input_text, joint_model, tokenizer, id2intent, id2slot, converter=None, split_text=split_text, max_seq_len=512):
...
def nlu_predict_m(input_text, joint_model, tokenizer, id2intent, id2slot, converter=None, split_text=split_text, max_seq_len=512):
